...
public class fra_coso extends PApplet {



//GLOBAL VARIABLES
int ITERATIONS = 100;
final float SAT = 0.8f; 
final int COLORS = 17; 
float m=0;
...
public float arctan(float a, float b){
...
public void zoom(float newOriginX, float newOriginY) {
...
class CloseButton extends Button
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "fra_coso" };
    if (passedArgs != null) {
